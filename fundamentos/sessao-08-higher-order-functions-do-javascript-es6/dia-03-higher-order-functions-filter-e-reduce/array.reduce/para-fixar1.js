...
// o "acc.nota" pega a nota atual e compara com a seguinte "materia.nota" retornando a maior nota.

const reportBest = (students) => students.map((student) => ({
  name: student.nome,
  materia: student.materias.reduce(getBestClass).name,
  // como o retorno de "getBestClass" é o objeto com a maior nota é possível escolher o valor da chave "name"
}));
